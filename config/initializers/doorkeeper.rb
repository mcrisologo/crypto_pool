Doorkeeper.configure do
  ...
  resource_owner_from_credentials do |_routes|
    ...
    return user if user && user.valid_for_authentication? { user.valid_password?(params[:password]) }
  ...
  admin_authenticator do
    ...
    current_user.present? ? current_user : redirect_to(new_user_session_url)
  end
